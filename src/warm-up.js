...
console.log("new page count: ", pages);
...
console.log("short story boolean: ", isShortStory);
...
var belowTwoHundred = [22, 44, 145, 155, 89, 99, 100, 101, 102, 2, 33, 4];
